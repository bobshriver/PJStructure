...
datapoints <- read.csv('AgeSt_mapping/dataset_locations.csv')

climpoints <- read.csv('AgeSt_mapping/climate_data_locations.csv')
...
lat.jitter <- c(0,amt,0,0,amt,0,amt,-amt,0,-amt,amt*1.5)
...
#ggsave("study_locations_mapped_v2.png", width = 4, height = 5, dpi = 500)
